...
pub fn calculate_intensity_at_point(x: u32, y: u32, width: usize, height: usize, spacing: u32, color_buf: &[f64]) -> f64 {
...
// Fix this
pub fn calculate_dots(deg_angle: f64, width: usize, height: usize, spacing: u32, color_buf: &[f64]) -> Vec<(u32, u32, f64)> {
